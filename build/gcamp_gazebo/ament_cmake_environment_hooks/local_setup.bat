...
set "AMENT_ENVIRONMENT_HOOKS[gcamp_gazebo]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[gcamp_gazebo] "%AMENT_CURRENT_PREFIX%\share\gcamp_gazebo\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[gcamp_gazebo] "%AMENT_CURRENT_PREFIX%\share\gcamp_gazebo\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[gcamp_gazebo]:;=";"%") do (
    call:call_file %%f
  )
