...
set "AMENT_ENVIRONMENT_HOOKS[custom_interfaces]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[custom_interfaces] "%AMENT_CURRENT_PREFIX%\share\custom_interfaces\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[custom_interfaces] "%AMENT_CURRENT_PREFIX%\share\custom_interfaces\environment\path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[custom_interfaces] "%AMENT_CURRENT_PREFIX%\share\custom_interfaces\environment\pythonpath.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[custom_interfaces]:;=";"%") do (
    call:call_file %%f
  )
