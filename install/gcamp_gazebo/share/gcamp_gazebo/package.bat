...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\gcamp_gazebo\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/gcamp_gazebo/local_setup.bat"
