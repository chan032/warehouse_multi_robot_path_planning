...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\py_service_pkg\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\py_service_pkg\hook\ament_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\..\..\build\py_service_pkg\share\py_service_pkg\hook\pythonpath_develop.bat"
